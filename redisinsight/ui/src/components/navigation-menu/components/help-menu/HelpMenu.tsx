...
const HelpMenu = () => {
  ...
  const HelpMenuButton = (
    <SideBarItem
      ...
      tooltipProps={{
        text: NAVIGATION_LABELS.help.tooltipText,
        placement: 'right',
      }}
    ...
    >
      <SideBarItemIcon
        icon={SupportIcon}
        aria-label={NAVIGATION_LABELS.help.ariaLabel}
        ...
        >
          <FeatureFlagComponent name={FeatureFlags.envDependent}>
            <FlexItem grow={2} className={styles.helpMenuItem}>
              ...
              >
                ...
                >
                  {NAVIGATION_LABELS.help.feedback}
                </Text>
              </Link>
            </FlexItem>
          ...
          <FlexItem className={styles.helpMenuItemRow} grow={4}>
            <Row className={styles.helpMenuItemLink} align="center" gap="xs">
              ...
              >
                {NAVIGATION_LABELS.help.keyboardShortcuts}
              </Text>
            </Row>
            ...
            <Row className={styles.helpMenuItemLink} align="center" gap="xs">
              ...
              >
                <Text size="xs" className={styles.helpMenuTextLink}>
                  {NAVIGATION_LABELS.help.releaseNotes}
                </Text>
              </Link>
            </Row>
            ...
            <FeatureFlagComponent name={FeatureFlags.envDependent}>
              <Row className={styles.helpMenuItemLink} align="center" gap="xs">
                ...
                >
                  {NAVIGATION_LABELS.help.resetOnboarding}
                </Text>
              </Row>
            </FeatureFlagComponent>
          </FlexItem>
