    ...
    <ContainerMinimized>
        ...
        <FeatureFlagComponent name={FeatureFlags.envDependent}>
          <FlexItem onClick={handleExpandMonitor} data-testid="expand-monitor">
            <ComponentBadge
              ...
              label={
                <Text size="S" variant="semiBold" component="span">
                  {COMMAND_HELPER_LABELS.profiler}
                </Text>
              }
      ...
      <FeatureFlagComponent name={FeatureFlags.envDependent}>
        ...
        >
          ...
          <HideFor sizes={['xs', 's']}>
            <span>{COMMAND_HELPER_LABELS.feedback}</span>
          </HideFor>
          <ShowFor sizes={['xs', 's']}>
            <span>{COMMAND_HELPER_LABELS.survey}</span>
          </ShowFor>
        </a>
      </FeatureFlagComponent>
    </ContainerMinimized>
