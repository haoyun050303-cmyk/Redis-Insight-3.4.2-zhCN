  ...
  return (
    <Row align="center" justify="between" gap="l" grow={false}>
      {onChangeMode && (
        <RiTooltip
          position="left"
          content={QUERY_LABELS.rawModeTooltip}
        ...
        >
          ...
          >
            ...
            <Text size="s">{QUERY_LABELS.rawMode}</Text>
          </ToggleButton>
        </RiTooltip>
      )}
      {onChangeGroupMode && (
        <RiTooltip
          position="left"
          content={<>{QUERY_LABELS.groupResultsTooltip}</>}
        ...
        >
          ...
          >
            ...
            <Text size="s">{QUERY_LABELS.groupResults}</Text>
          </ToggleButton>
        </RiTooltip>
      )}
      ...
      <RiTooltip
        position="left"
        content={
          isLoading ? QUERY_LABELS.waitExecuting : KeyBoardTooltipContent
        }
