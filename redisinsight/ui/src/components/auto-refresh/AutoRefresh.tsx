...
import { BROWSER_LABELS } from 'uiSrc/pages/browser/browser.labels'
    ...
    >
      {displayText && (
        <FlexItem>
          ...
          >
            {enableAutoRefresh
              ? BROWSER_LABELS.autoRefresh
              : BROWSER_LABELS.lastRefresh}
          </ColorText>
        </FlexItem>
      )}
      {displayLastRefresh && (
      ...
      <FlexItem>
        <Row align="center" gap="none">
          <FlexItem>
            <RiTooltip
              title={!disabled && BROWSER_LABELS.lastRefreshTooltip}
          ...
          <FlexItem>
            <RiPopover
              ...
              button={
                <AutoRefreshConfigButton
                  ...
                  aria-label={BROWSER_LABELS.autoRefreshConfig}
            ...
            >
              <SwitchInput
                title={BROWSER_LABELS.autoRefreshSwitch}
