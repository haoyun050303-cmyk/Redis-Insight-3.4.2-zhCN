...
const ConnectivityOptions = (props: Props) => {
  ...
  return (
    <>
      <section>
        <Text color="primary">
          {HOME_LABELS.connectivityOptions.cloudAccount}
        </Text>
        <Spacer />
          ...
          <FlexItem>
            ...
            >
              <Col align="center" gap="s">
                ...
                <Text color="primary">
                  {HOME_LABELS.connectivityOptions.addDatabases}
                </Text>
              </Col>
            </StyledConnectivityLink>
          </FlexItem>
                ...
                {(ssoCloudHandlerClick, isSSOEnabled) => (
                  ...
                  >
                    ...
                    <Col align="center" gap="s">
                      ...
                      <Text color="primary">
                        {HOME_LABELS.connectivityOptions.newDatabase}
                      </Text>
                    </Col>
                  </StyledConnectivityLink>
                )}
      ...
      <section>
        <Text color="primary">
          {HOME_LABELS.connectivityOptions.moreOptions}
        </Text>
        <Spacer />
        ...
        {loadingOption && (
          <>
            ...
            <Row justify="center">
              ...
              >
                {HOME_LABELS.connectivityOptions.cancel}
              </SecondaryButton>
            </Row>
          </>
        )}
