...
const ConnectionUrlError = (
  <>
    {HOME_LABELS.addDatabase.connectionUrlError}
    <br />
    {HOME_LABELS.addDatabase.connectionUrlErrorHint}
  </>
)
  ...
  return (
    <ScrollableWrapper>
        ...
        <Row responsive justify="between" align="center">
          <FlexItem>
            ...
            >
              ...
              >
                {HOME_LABELS.addDatabase.testConnection}
              </EmptyButton>
            </RiTooltip>
          </FlexItem>
          <FlexItem>
            <Row responsive gap="l">
              <FlexItem>
                ...
                >
                  {HOME_LABELS.addDatabase.connectionSettings}
                </SecondaryButton>
              </FlexItem>
              <FlexItem>
                <RiTooltip
                ...
                >
                  ...
                  >
                    {HOME_LABELS.addDatabase.submit}
                  </PrimaryButton>
                </RiTooltip>
              </FlexItem>
            </Row>
      ...
      <CustomHorizontalRule>
        {HOME_LABELS.addDatabase.separator}
      </CustomHorizontalRule>
      <Spacer />
      <ConnectivityOptions
