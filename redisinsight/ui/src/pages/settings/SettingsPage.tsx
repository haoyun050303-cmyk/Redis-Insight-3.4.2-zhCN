...
const SettingsPage = () => {
  ...
  setTitle(SETTINGS_LABELS.title)
    ...
    <div>
      ...
      <CallOut className={styles.warning}>
        <Text size="s" className={styles.smallText}>
          {SETTINGS_LABELS.advancedWarning}
        </Text>
      </CallOut>
      <AdvancedSettings />
    </div>
        ...
        <PageContentBody style={{ maxWidth: 792 }}>
          <Col gap="s">
            ...
            <RICollapsibleNavGroup
              isCollapsible
              className={styles.accordion}
              title={SETTINGS_LABELS.workbench}
            ...
            <FeatureFlagComponent name={FeatureFlags.cloudSso}>
              <RICollapsibleNavGroup
                ...
                title={SETTINGS_LABELS.redisCloud}
            ...
            <RICollapsibleNavGroup
              isCollapsible
              className={cx(styles.accordion, styles.accordionWithSubTitle)}
              title={SETTINGS_LABELS.advanced}
