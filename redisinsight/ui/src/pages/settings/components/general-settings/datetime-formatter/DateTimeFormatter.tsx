...
const DateTimeFormatter = () => {
  ...
  return (
    <>
      <Title size="M">{SETTINGS_LABELS.dateTime.title}</Title>
      <Spacer size="m" />
      <Text color="primary">{SETTINGS_LABELS.dateTime.dateSummary}</Text>
      <Spacer size="m" />
      <DatetimeForm onFormatChange={(newPreview) => setPreview(newPreview)} />
      <Spacer size="m" />
      <Text color="primary">{SETTINGS_LABELS.dateTime.timezoneSummary}</Text>
      <Spacer size="s" />
      <Row align="center" justify="between" gap="m">
        ...
        <Row align="center" gap="m" grow={false}>
          <Text color="primary" size="m">
            {SETTINGS_LABELS.dateTime.preview}
          </Text>
          <TextInput
            variant="outline"
            value={preview}
