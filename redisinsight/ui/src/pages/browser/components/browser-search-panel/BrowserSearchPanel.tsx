  ...
  const searchModes: ISwitchType<SearchMode>[] = [
    {
      ...
      tooltipText: BROWSER_LABELS.filterByKeyNameOrPattern,
      ariaLabel: `${BROWSER_LABELS.filterByKeyNameOrPattern} button`,
    ...
    },
    {
      ...
      tooltipText: BROWSER_LABELS.searchByValuesOfKeys,
      ariaLabel: `${BROWSER_LABELS.searchByValuesOfKeys} button`,
