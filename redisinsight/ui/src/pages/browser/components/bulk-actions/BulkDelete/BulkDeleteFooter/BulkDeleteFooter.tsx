      ...
      >
        <Row grow={false}>
          <Checkbox
            ...
            label={BROWSER_LABELS.bulk.downloadReport}
            data-testid="download-report-checkbox"
          />

          <RiTooltip
            content={BROWSER_LABELS.bulk.downloadReportTooltip}
            position="left"
          >
            <RiIcon
              type="InfoIcon"
        ...
        {!isProcessedBulkAction(status) && !isProduction && (
          <ConfirmationPopover
            ...
            button={
              ...
              >
                {BROWSER_LABELS.bulk.delete}
              </PrimaryButton>
            }
            title={BROWSER_LABELS.bulk.confirmActionTitle}
            message={BROWSER_LABELS.bulk.deleteConfirmMessage}
            appendInfo={
              <Row align="center" gap="m">
                <RiIcon size="xl" type="ToastDangerIcon" />
                <Text size="s">{BROWSER_LABELS.bulk.deleteImpactWarning}</Text>
              </Row>
            }
            confirmButton={
              <DestructiveButton
        ...
        {!isProcessedBulkAction(status) && isProduction && (
          <>
            ...
            {isTypeToConfirmOpen && (
              <TypeToConfirmModal
                title={BROWSER_LABELS.bulk.deleteAllMatchingKeys}
                confirmationText={confirmationText}
                confirmButtonText={BROWSER_LABELS.bulk.delete}
                actionDescription={BROWSER_LABELS.bulk.deleteActionDescription}
