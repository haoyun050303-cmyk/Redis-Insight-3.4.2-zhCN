...
const placeholders = {
  [SearchMode.Pattern]: BROWSER_LABELS.filterByKeyNameOrPattern,
  [SearchMode.Redisearch]: BROWSER_LABELS.searchByValuesOfKeys,
}
    ...
    >
      <MultiSearch
        ...
        suggestions={{
          ...
          buttonTooltipTitle: BROWSER_LABELS.showHistory,
          loading:
            searchMode === SearchMode.Pattern
