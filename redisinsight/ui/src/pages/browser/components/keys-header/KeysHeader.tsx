  ...
  const viewTypes: ISwitchType<KeyViewType>[] = [
    {
      ...
      tooltipText: BROWSER_LABELS.listView,
    ...
    },
    {
      ...
      tooltipText: isTreeViewDisabled
        ? BROWSER_LABELS.treeViewUnavailableHex
        : BROWSER_LABELS.treeView,
                ...
                <FlexItem>
                  <AutoRefresh
                    ...
                    disabledRefreshButtonMessage={
                      BROWSER_LABELS.selectIndexToRefresh
                    }
                    iconSize="S"
                    postfix="keys"
                    loading={loading}
                  ...
                  <RiPopover
                    ...
                    button={
                      <ToggleButton
                        ...
                        aria-label={BROWSER_LABELS.columns}
                        pressed={columnsConfigShown}
                      >
                        <RiIcon size="m" type="ColumnsIcon" />
                        <Text size="s">{BROWSER_LABELS.columns}</Text>
                      </ToggleButton>
                    }
                  >
                    <Col gap="m">
                      <FlexItem>
                        <Row align="center" gap="m">
                          ...
                          <FlexItem>
                            <RiTooltip
                              content={BROWSER_LABELS.keySizeTip}
                              position="top"
