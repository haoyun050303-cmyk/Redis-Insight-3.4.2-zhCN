...
import Node, { getFolderTooltipKeyCountText } from './Node'
...
describe('Node', () => {
  ...
  describe('showFolderMetadata', () => {
    ...
    it('should format localized folder tooltip key count', () => {
      expect(getFolderTooltipKeyCountText(2, 4.88)).toEqual('2 个键 (4.88%)')
    })
  })
