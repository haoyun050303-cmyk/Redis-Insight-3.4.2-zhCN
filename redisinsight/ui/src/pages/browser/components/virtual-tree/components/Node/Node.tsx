...
export const getFolderTooltipKeyCountText = (
  keyCount?: number,
  keyApproximate = 0,
) =>
  `${keyCount} ${BROWSER_LABELS.keyCount} (${
    Math.round(keyApproximate * 100) / 100
  }%)`
...
const Node = ({
  ...
  const tooltipContent = (
    <>
      ...
      <ColorText color="secondary">
        {getFolderTooltipKeyCountText(keyCount, keyApproximate)}
      </ColorText>
    </>
  )
